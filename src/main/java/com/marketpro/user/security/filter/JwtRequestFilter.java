package com.marketpro.user.security.filter;

import com.marketpro.user.model.authentication.AJwtRequest;
import com.marketpro.user.security.CustomAuthenticationProvider;
...
// Once we get the token validate it.
		if (username != null && SecurityContextHolder.getContext().getAuthentication() == null) {
			AJwtRequest jreq = new AJwtRequest();
			jreq.setMobile(username);
			Authentication userDetails = this.authProvider.getUserDetails(jreq);
